...
<head>
    ...
    <!--Подключим https://github.com/marioloncarek/megamenu-js-->
        ...
        <div class="top-header-main">
            ...
            <div class="col-md-6 top-header-left">
                <div class="cart box_1">
                    ...
                    <!--
                    Если js не работает то перейдем по href="cart/show"
                    Если работает, то вызовем метод getCart.
                    return false; - остановит перед по ссылке
                    -->
                    ...
                    <div class="menu">
                        <?php
                            new \app\widgets\menu\Menu([
                                'tpl' => WWW . '/menu/menu.php', // переопределили путь к шаблону
                                'container' => 'ul',
                            ]);
                        ?>
                    </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="cart/view" type="button" class="btn btn-primary">
                    Оформить заказ
                </a>
