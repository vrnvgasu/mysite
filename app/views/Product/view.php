        ...
        <div class="single-main">
            <div class="col-md-9 single-main-left">
                <div class="sngl-top">
                    ...
                    <?php
                        $curr = \ishop\App::$app->getProperty('currency'); // текущая валюта
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <div class="quantity">
                                <input type="number" size="4" value="1" name="quantuty" min="1" step="1">
                            </div>
                        ...
                        <?php foreach ($related as $item) : ?>
                            ...
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <p>Explore Now</p>
                                    <!--add-to-cart-link - свой класс для скрипта добавления в корзину-->
                                    <h4>
                                        ...
                                        <?php if ($item['old_price']) : ?>
                                            <del>
                                                <?= $curr['symbol_left']; ?> <?=round($item['old_price'] * $curr['value']);?> <?= $curr['symbol_right']; ?>
                                            </del>
                                        <?php endif; ?>
                                    </h4>
                                </div>
                ...
                <?php if ($recentlyViewed) : ?>
                    <div class="latestproducts">
                        <div class="product-one">
                            <h3>Недавное просмотренные товары:</h3>
